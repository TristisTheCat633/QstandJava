...
public class Console_U {
    ...
    public void BookingSuccess(){
        ...
        System.out.println(u_name+" has booked "+uses+" times.");
    ...
    public void Confirmation_or_Cancellation(){
        ...
        System.out.println("\nPlease confirm the ride or cancel the booking before proceeding.....");
        String C_or_C = choice.nextLine();
        if (C_or_C.equals("1")){
            System.out.println("The ride has been confirmed.");
            System.out.println("Enjoy the smooth journey ahead!");
        } else if (C_or_C.equals("2")) {
